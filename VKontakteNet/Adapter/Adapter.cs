...
namespace VKontakteNet
{
    ...
    public abstract class Adapter
    {
        ...
        {
            return WallPost(_connection.UserId, message);
        }
        ...
        {
            return GetWall(_connection.UserId);
        }
        ...
        public XmlDocument GetWall(int uid)
        {
          ...
          qs["owner_id"] = uid.ToString();
          qs["count"] = "100";
          return ExecuteRequest("wall.get", qs);
        }
        ...
        public string GetCity(int id)
        {
            ...
            NameValueCollection qs = new NameValueCollection();
            qs["api_id"] = _connection.ApplicationId.ToString();
            //qs["sig"] = this.AccessToken;
            qs["cids"] = id.ToString();
            var city = ExecuteRequest("getCities", qs);
